...
function custom_product_settings_fields() {
...
add_action('woocommerce_product_options_general_product_data', 'custom_product_settings_fields');
...
// Save custom fields
function save_custom_product_settings_fields($post_id) {
...
add_action('woocommerce_process_product_meta', 'save_custom_product_settings_fields');
