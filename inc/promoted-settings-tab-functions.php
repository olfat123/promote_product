...
add_filter('woocommerce_get_sections_products', 'promoted_product_settings_section');

function promoted_product_settings_section($sections) {
...
add_filter( 'woocommerce_get_settings_products', 'promoted_section', 10, 2 );
function promoted_section( $settings, $current_section ) {
...
add_action('woocommerce_admin_field_promoted_section_dynamic_field','admin_field_promoted_section_dynamic_field');
function admin_field_promoted_section_dynamic_field($value){
    ...
    add_action('woocommerce_update_option_promoted_section_dynamic_field','update_option_promoted_section_dynamic_field');
    function update_option_promoted_section_dynamic_field($value){
