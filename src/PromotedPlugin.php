...
class PromotedPlugin {
	...
	private function init() {
		...
		add_filter( 'woocommerce_admin_settings_sanitize_option', array( $promoted_settings_tab, 'update_option_promoted_section_dynamic_field' ) );
		add_action( 'wp_enqueue_scripts', array( $assets, 'enqueue_custom_scripts_and_styles' ) );
		add_action( 'admin_enqueue_scripts', array( $assets, 'enqueue_promoted_admin_scripts_and_styles' ) );
